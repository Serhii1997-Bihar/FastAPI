...
tasks = [
    {'id': 1, 'title': 'Налаштувати базу даних для Віктора',
     'description': 'Через недбале використання ресурсі бази дан'
    'их сталась атака ботів і тепер база даних підвисає',
     'status': 'in progress', 'date': '16-04-2024 18:03'},
    {'id': 2, 'title': 'Полагодити ноутбук в основному офісі',
     'description': 'Через надмірне використання увімкненого ноут він згорів і тепер не включається',
     'status': 'completed', 'date': '18-08-2022 09:44'},
    {'id': 3, 'title': 'Полагодити камери на магазині',
     'description': 'Через надмірне використання тепер камери нне працюють і не видно нічого',
     'status': 'completed', 'date': '18-12-2023 10:13'},
    {'id': 4, 'title': 'Купити клавіатуру для 4 магазинів',
     'description': 'Через відкриття нових магазинів треба купити нові такі штуки',
